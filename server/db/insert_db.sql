...
*/
INSERT INTO Connection (Type, Description) 
VALUES 
('Collateral Consequence', 'This type of connection between nodes occurs when a node has an unforeseen impact that leads to the creation of a document or action.');

INSERT INTO Connection (Type, Description) 
VALUES 
('Direct Consequence', 'Direct consequence is the most common type of connection between nodes and appears whenever a document explicitly anticipates the creation of another document or subsequent action.');

INSERT INTO Connection (Type, Description) 
VALUES 
('Projection', 'This is a type of connection between nodes that is similar to a direct consequence, but the generating document (or more commonly, the material effect) precedes the resulting document.');

INSERT INTO Connection (Type, Description) 
VALUES 
('Update', 'This type of node connection, which, as the name suggests, simply connects two documents that perform the same function but succeed each other over time, like the various deformation forecasts.');


/*
    insertion of documents from the file
*/
