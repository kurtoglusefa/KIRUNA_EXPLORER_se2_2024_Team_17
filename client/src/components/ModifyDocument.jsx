      ...
      <Card className="container my-5 bg-light rounded form">
            ...
            <Col md={6}>
              ...
              <Form.Group controlid="scale" className="mb-3">
                <InputGroup>
                  ...
                  // className={`font-size-20 ${formSubmitted && (!documentScale || documentScale.id === 0) ? "blink" : ""}`}
                  >
              ...
              <Form.Group controlid="language" className="mb-3">
                <FloatingLabel label="Language" className="mb-3">
                  ...
                  // className={formSubmitted && !language ? "blink" : ""}
                  >
                ...
                <Form.Group controlid="pages" className='col-2'>
                  <FloatingLabel label="Pages" className="mb-3">
                    <Form.Control
                      ...
                      min={0}
                    // className={formSubmitted && (!pages || pages <= 0) ? "blink" : ""}
                    />
                  </FloatingLabel>
                </Form.Group>
                ...
                <Form.Group controlid="issuanceDate" className="ms-1 mb-3 d-flex align-items-center">
                  ...
                  <FloatingLabel label='year*'>
                    ...
                    <Form.Control
                      ...
                      className={`mx-1 ${formSubmitted && !issuanceDate.year ? "blink" : ""}`}
                    />
                  </FloatingLabel>
                  /
              ...
              <FormGroup controlid="stakeholder" className="mb-3">
                <FloatingLabel label="Stakeholder*" className="mb-3">
                  <Form.Select
                    ...
                    // className={formSubmitted && (!stakeholder.id || stakeholder.id === 0) ? "blink" : ""}
                    value={stakeholder.id || ''}
                    onChange={(e) => setStakeholder({ id: e.target.value })}
                    className={formSubmitted && (!stakeholder.id || stakeholder.id === 0) ? "blink" : ""}
                  >
              ...
              <FormGroup controlid="type" className="mb-3">
                <FloatingLabel label="Document Type*" className="mb-3">
                  <Form.Select
                    ...
                    // className={formSubmitted && (!type.id || type.id === 0) ? "blink" : ""}
                    value={type.id || ''}
              ...
              <Form.Group controlid="description" className="mb-3">
                <FloatingLabel label="Description*" className="mb-3">
                  <Form.Control
                    ...
                    className={`mt-auto ${formSubmitted && !description ? "blink" : ""}`}
                  />
                </FloatingLabel>
        ...
        <div className="d-flex justify-content-center mb-4 mx-5">
          ...
          <Button
            ...
            onClick={() => {
              setFormSubmitted(true); // Enable validation on fields
              const isValid =
                title &&
                documentScale &&
                issuanceDate.year &&
